...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            trained_metric = get_regression_score(y_true, np.exp(y_trained_pred))
            latest_metric = get_regression_score(y_true, np.exp(y_latest_pred))

            improved_accuracy = trained_metric.model_r2_score-latest_metric.model_r2_score
